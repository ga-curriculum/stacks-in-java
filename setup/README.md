...
Name the project `stacks-in-java`.
...
After confirming that the **New Project** window looks similar to the screenshot below, select the **Create** button. The name of the project should be `stacks-in-java`, not `untitled`.
